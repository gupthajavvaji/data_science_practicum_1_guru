...
# Download the USDA organic trends PDF
...
# Extract text from the first few pages to get an overview
text = ""
...
# Print the extracted text to understand the content
print(text[:1000])  # Print the first 1000 characters for a quick overview
...
# Generate synthetic customer data with additional features
data = {
    'customer_id': range(1, n_customers + 1),
    'age': np.random.randint(18, 80, n_customers),
    'income': np.random.randint(20000, 200000, n_customers),
...
# Load the Instacart data files into dataframes
...
# Create a function for personalized product recommendations
...
# Display some statistics about organic products
print("\
...
# Calculate organic preference for each user
...
# Analyze organic purchases by day of week
